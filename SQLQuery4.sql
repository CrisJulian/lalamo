...
-- Run this on a brand new empty AOOP_DB database
-- ============================================================
...
-- ============================================================
-- DONE - All tables and views created successfully.
-- Tables: Users, Categories, Transactions, Budgets,
--         SavingsGoals, Debts, DebtPayments, RecurringPayments
-- Views:  vw_MonthlySpendingByCategory, vw_UserBalance,
