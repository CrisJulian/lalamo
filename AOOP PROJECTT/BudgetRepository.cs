...
// Handles all database operations for Budgets and Savings Goals.
...
namespace AOOP_PROJECTT
{
    public static class BudgetRepository
    {
        ...
        /// Load all budgets for the logged-in user for the current month.
        ...
        /// Update the Spent amount for an existing budget.
        ...
        /// Load all savings goals for the logged-in user.
